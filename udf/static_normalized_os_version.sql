CREATE TEMP FUNCTION udf_static_normalized_os_version() AS (
  ARRAY<STRUCT<os_name STRING, os_version_regexp STRING, normalized_os_name STRING, normalized_os_version STRING, release_date STRING>>[
